  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        gold: { DEFAULT: "hsl(var(--gold))", light: "hsl(var(--gold-light))", foreground: "hsl(var(--gold-foreground))" },
        crimson: { DEFAULT: "hsl(var(--crimson))", dark: "hsl(var(--crimson-dark))", light: "hsl(var(--crimson-light))", foreground: "hsl(var(--crimson-foreground))" },
        forest: { DEFAULT: "hsl(var(--forest))", light: "hsl(var(--forest-light))", foreground: "hsl(var(--forest-foreground))" },
