...
const stats = [
  { icon: Calendar, key: "stat_1", value: "১৯৮৩", labelBn: "প্রতিষ্ঠা", labelEn: "Founded" },
  { icon: Users, key: "stat_2", value: "৪০+", labelBn: "নির্বাহী সদস্য", labelEn: "Executive Members" },
  { icon: Award, key: "stat_3", value: "৩০+", labelBn: "সংবর্ধিত গুণীজন", labelEn: "Honoured Personalities" },
  { icon: BookOpen, key: "stat_4", value: "৪০+", labelBn: "বছরের ঐতিহ্য", labelEn: "Years of Legacy" },
];
...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-4 lg:px-8 text-center relative">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <EditableText
                ...
                sectionKey="hero"
                elementKey="badge"
                defaultBn="মহাফেজখানা থেকে"
                defaultEn="From the Archives"
                as="p"
                className="text-accent text-sm tracking-[0.2em] uppercase font-semibold mb-3 block"
              />
            </motion.div>
            ...
            <EditableText
              ...
              sectionKey="hero"
              elementKey="subtitle"
              defaultBn="১৯৮৩ সালে প্রতিষ্ঠিত ফরিদপুরের অগ্রগণ্য সাহিত্য সংগঠনের ইতিহাস ও কর্মযজ্ঞ"
              defaultEn="The history and work of Faridpur’s foremost literary society, founded in 1983."
              multiline
              as="p"
              className="font-bengali text-primary-foreground/80 max-w-2xl mx-auto block"
            />
          </div>
        </section>
      </EditableSection>
              ...
              {stats.map((s, i) => (
                ...
                >
                  ...
                  <EditableText
                    pageKey="about"
                    sectionKey="stats"
                    elementKey={`${s.key}_val`}
                    defaultBn={s.value}
                    defaultEn={s.value}
                    as="p"
                    className="font-bengali text-2xl md:text-3xl font-bold text-foreground block"
                  />
                  <EditableText
                    pageKey="about"
                    sectionKey="stats"
                    elementKey={`${s.key}_label`}
                    defaultBn={s.labelBn}
                    defaultEn={s.labelEn}
                    as="p"
                    className="font-bengali text-xs text-muted-foreground mt-1 block"
                  />
                </motion.div>
              ))}
            </div>
      ...
      {/* History */}
      <EditableSection pageKey="about" sectionKey="history" sectionTitle="প্রতিষ্ঠার পূর্বকথা ও ইতিহাস (History)">
        <section className="py-12">
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            <EditableText
              ...
              sectionKey="history"
              elementKey="heading"
              defaultBn="প্রতিষ্ঠার পূর্বকথা"
              defaultEn="The Story Behind the Founding"
              as="h2"
              className="font-bengali text-2xl md:text-3xl font-bold text-foreground mb-6 block"
            />
      ...
      {/* Birth anniversaries */}
      <EditableSection pageKey="about" sectionKey="anniversaries" sectionTitle="জন্মশতবার্ষিকী উদযাপন (Centenaries)">
        <section className="py-12 bg-warm-gradient">
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            <EditableText
              ...
              elementKey="heading"
              defaultBn="যাঁদের জন্মশতবার্ষিকী উদযাপন করা হয়েছে"
              defaultEn="Centenary Celebrations Hosted"
              as="h2"
              className="font-bengali text-2xl md:text-3xl font-bold text-foreground mb-2 block"
            />
            <EditableText
              pageKey="about"
              sectionKey="anniversaries"
              elementKey="subtitle"
              defaultBn="জাতির মণিষীদের স্মরণে পরিষদের আয়োজিত অনুষ্ঠানগুলি"
              defaultEn="Anniversary observances organised by the Parishad."
              as="p"
              className="font-bengali text-sm text-muted-foreground mb-8 block"
            />
      ...
      <EditableSection pageKey="about" sectionKey="honoured" sectionTitle="সংবর্ধিত গুণীজন (Honoured Personalities)">
        <section className="py-12">
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            <EditableText
              pageKey="about"
              sectionKey="honoured"
              elementKey="heading"
              defaultBn="যাঁদের সংবর্ধনা জানানো হয়েছে"
              defaultEn="Honoured Personalities"
              as="h2"
              className="font-bengali text-2xl md:text-3xl font-bold text-foreground mb-2 block"
            />
            <EditableText
              ...
              sectionKey="honoured"
              elementKey="subtitle"
              defaultBn="ফরিদপুর সাহিত্য পরিষদ যে সকল গুণীজনকে সংবর্ধনা জানিয়েছে"
              defaultEn="Personalities honoured by Faridpur Shahitto Parishad over the years."
              as="p"
              className="font-bengali text-sm text-muted-foreground mb-8 block"
            />
      ...
      {/* Contact */}
      <EditableSection pageKey="about" sectionKey="contact" sectionTitle="যোগাযোগ (Contact Info)">
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
            <EditableText
              ...
              defaultEn="Contact"
              as="h2"
              className="font-bengali text-2xl md:text-3xl font-bold text-foreground mb-6 text-center block"
            />
